    ...
    <div ref={containerRef} className="text-text-primary min-h-screen relative overflow-hidden">
      ...
      <div className="sticky top-0 w-full z-50 bg-bg-primary/50 backdrop-blur-lg border-b border-border-default/45 shadow-sm transition-colors duration-300">
        <div className="flex items-center justify-between px-4 sm:px-6 py-3.5 sm:py-4 max-w-6xl mx-auto w-full">
          <a href="/" className="flex items-center gap-2 sm:gap-2.5 group shrink-0 cursor-pointer">
      ...
      <div className="fixed inset-0 z-0 flex items-start justify-center pointer-events-none overflow-hidden pt-[11vh]">
        <motion.h1
          style={{ y: riserY, scale: riserScale, opacity: riserOpacity, fontFamily: "var(--font-bebas)" }}
          className="text-[clamp(2rem,11.5vw,20rem)] font-normal leading-none text-text-primary whitespace-nowrap tracking-tighter select-none drop-shadow-[0_0_15px_rgba(0,0,0,0.05)] dark:drop-shadow-[0_0_15px_rgba(255,255,255,0.2)] w-full text-center"
        >
